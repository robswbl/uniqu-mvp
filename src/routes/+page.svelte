    ...
    <div class="w-full max-w-md rounded-lg bg-white p-8 shadow-md">
      ...
      {#if feedbackMessage}
        <p
          ...
          class:text-red-500={feedbackMessage.startsWith('Error') || feedbackMessage === 'Incorrect password.'}
          class:text-green-600={!feedbackMessage.startsWith('Error') && feedbackMessage !== 'Incorrect password.'}
        >
          {feedbackMessage}
        </p>
      {/if}
