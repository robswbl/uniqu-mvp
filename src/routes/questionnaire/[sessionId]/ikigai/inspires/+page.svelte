<script lang="ts">
	...
	function goToNext() {
		goto(`/questionnaire/${sessionId}/ikigai/want_to_be`);
	}
	function goToBack() {
		...
		{#if showInspiration}
			<div class="mt-2 space-y-3 rounded-lg border border-orange-200 bg-orange-50 p-4">
				<p class="text-sm text-gray-600">
					Which industries or fields capture your imagination? What draws you to them - innovation,
					helping people, creativity, or something else?
				</p>
				<p class="text-xs text-gray-500 italic">
					Examples: Software because I like creating things people use. Animal welfare because I
					want to help them. Recruiting because I meet interesting people.
				</p>
			</div>
		{/if}
	</div>
