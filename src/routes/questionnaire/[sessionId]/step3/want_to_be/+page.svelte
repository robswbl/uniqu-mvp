...
>
	...
	<div class="mt-4 flex items-center">
		<button
			type="button"
			class="flex items-center rounded-lg bg-purple-100 px-4 py-2 text-purple-700 shadow-sm hover:bg-purple-200 focus:ring-2 focus:ring-purple-400 focus:outline-none disabled:opacity-50"
		...
		>
			...
			{recognizing
				? $t('step3.want_to_be.listening') || 'Listening...'
				: $t('step3.want_to_be.speak') || 'Speak'}
		</button>
		<span class="ml-3 text-sm text-gray-500"
			>{recognizing ? $t('step3.want_to_be.listening') || 'Listening...' : ''}</span
		>
	</div>
</QuestionCard>
